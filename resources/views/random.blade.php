...
@section('title')
    ...
    BSP - Generator - Duplas Aleatórias
...
@section('content')    
        ...
        <div style="width: 95%; margin: auto; padding: 5px">
            ...
            {!! Form::open(['url'=>'/random/result', 'name' => 'form', 'id' => 'idform']) !!}
            ...
            <div class="{{ $errors->has('players') ? 'has-error' : '' }}">
                {!! Form::label('Jogadores:') !!}
                {!! Form::textarea('players', old('players'), ['class'=>'form-control', 'placeholder'=>'adicionar jogadores (1 jogador por linha)', 'rows' => '12']) !!}
            ...
            <button class="btn btn-primary">Gerar Duplas</button>
            </div>
        ...
        <div style="width: 95%; margin: auto; padding: 5px">
            ...
            @if($pares != '') 
                ...
                <div style="background-color: #eae1be; padding: 5px;">
        ...
        <div style="width: 95%; margin: auto; padding: 5px;">
                ...
                <div style="background-color: #eae1be; margin: auto; padding: 5px; text-align: center;
