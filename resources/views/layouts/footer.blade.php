            ...
            <div class="row">
                <div class="col-md-7">
                    ...
                    <div class="col-sm-11 text-white">
                        <div>
                            <p>Pedro Brandão, Copyright &copy; 2019 | <a href="https://github.com/brandaopj"> GitHub </a></p>
                        </div>
                    </div>
                </div>
            </div>
            <div class="col-md-5">
                ...
                <div class="d-inline-block">
                    <div class="bg-circle-outline d-inline-block" style="background-color:#3b5998">
                        <a href="https://www.facebook.com/BeerSocialPadel/"><i class="fa fa-2x fa-fw fa-facebook text-white"></i></a>
                    </div>
                    
                    <div class="bg-circle-outline d-inline-block" style="background-color:#4099FF">
                        <a href="https://www.instagram.com/beersocialpadel.bsp/?hl=pt">
                    ...
                    <div class="bg-circle-outline d-inline-block" style="background-color:#d34836">
                        <a href="https://www.youtube.com/channel/UCP-_X9u2XK0cGFrYaEWYSAg">
                        <i class="fa fa-2x fa-fw fa-youtube text-white"></i></a>
                    </div>
