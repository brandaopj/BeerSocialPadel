...
@section('content')
        ...
        <div class="table-responsive" style="margin: 0; width: 100%; background-color: #142C36; color: white;  padding: 10px; padding-left: 30px; padding-right: 30px;">
			...
			<p>Este é o grupo principal do BSP, é aqui que se discute tudo sobre o universo BSP, desde sorteios, resultados de torneios, partilha de fotografias dos nossos jogadores, etc.</p>

            <p>É também neste grupo, que qualquer membro BSP pode solicitar a marcação de jogos, fora dos torneios BSP, mas com as seguintes regras:</p>
